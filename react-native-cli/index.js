...
var resolveSymlink = require('resolve-symlink');
/**
 * Used arguments:
...
var REACT_NATIVE_DIR = function() {
  var dir = path.resolve('node_modules', 'react-native');
  return fs.existsSync(dir) ? resolveSymlink(dir) : dir;
};
