...
const MARKER_IOS = exec(`mktemp ${ROOT}/react-native-cli/generator-ios/templates/app/XXXXXXXX`).stdout.trim();
const MARKER_ANDROID = exec(`mktemp ${ROOT}/react-native-cli/generator-android/templates/src/XXXXXXXX`).stdout.trim();
